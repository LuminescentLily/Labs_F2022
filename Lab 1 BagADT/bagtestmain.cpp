...
int main() {
	...
	cout << "Mikaela Harley -- CSIS 215 Programming Assignment 1 -- Bag Dictionary" << endl << endl;
	...
	KVpair<int, string> dot(919, "suffering");
	cout << "Testing ABag functions." << "\n\n";
	myBag.operator+=(dot);
	cout << "This is the bag size at first: "<<myBag.size() << endl;
	cout << "This is the bag capacity: "<<myBag.bagCapacity() << endl;
	//cout << myBag.size() << endl;
	//if (myBag.find(dot) == true) { cout << "---FIND works!!!!" << endl; }
	//if (myBag.remove(dot) == true) { cout << "---REMOVE works!!!!" << endl; }
	//if (myBag.inspectTop(dot) == true) { cout << "---INSPECT_TOP works!!!!" << endl; }
	if (myBag.removeTop(dot) == true) { cout << "---REMOVE_TOP works!!!!" << endl; }
	cout <<"This is the size after removeTop has run: "<< myBag.size() << endl;
	//myBag.operator+=(dot);
	//cout << "----ADD_ITEM works!!!!!" << endl;
	//myBag.emptyBag();
	//cout << myBag.size() << endl;
